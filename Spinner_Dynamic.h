...
/**
 * @brief return interaction energy with neighbour spinner
 * @param spin is the vector with all the spinner of lattice
 * @param i_elem index of spinner of interest
 ...
 * @param nx size of lattice along y
 */
double interaction( std::vector<Spinner>& spin, int i_elem, double J, double Jdouble, int nx, int ny);
 ...
 */
std::vector<std::vector<int>> Metropolis(std::vector<Spinner>& spin, double lambda, double T0, double Tf, double J,
	double Jdouble, unsigned long int Niteration, int Nsimulation, int nx, int ny, int p);
